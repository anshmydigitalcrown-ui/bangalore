...
export default function Home() {
  ...
  return (
    <main className="min-h-screen bg-darker-bg">
      ...
      {/* Footer */}
      <footer className="bg-gradient-to-br from-black via-darker-bg to-deep-red/5 px-6 py-16 border-t border-deep-red/20">
        <div className="max-w-7xl mx-auto">
          {/* Main Footer Content */}
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8 mb-12">
            ...
            <div className="lg:col-span-2">
              ...
              <div className="flex space-x-4">
                {/* Social Media Icons */}
                <a href="#" className="w-10 h-10 bg-gradient-to-r from-deep-red to-dark-red rounded-full flex items-center justify-center hover:scale-110 transition-transform duration-300 group">
          ...
          <div className="bg-gradient-to-r from-deep-red/10 via-dark-red/10 to-deep-red/10 rounded-2xl p-6 mb-8 border border-deep-red/20">
            <div className="grid md:grid-cols-3 gap-6 text-center">
              <div className="flex items-center justify-center space-x-3">
                <div className="w-12 h-12 bg-gradient-to-r from-deep-red to-dark-red rounded-full flex items-center justify-center">
                  <svg className="w-6 h-6 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z" />
                  </svg>
                </div>
          ...
          {/* Bottom Footer */}
          <div className="border-t border-deep-red/20 pt-8">
          ...
          {/* Decorative Elements */}
          <div className="absolute bottom-0 left-0 w-32 h-32 bg-gradient-to-r from-deep-red/10 to-transparent rounded-full blur-xl"></div>
          <div className="absolute bottom-0 right-0 w-24 h-24 bg-gradient-to-l from-dark-red/10 to-transparent rounded-full blur-xl"></div>
        </div>
      </footer>
    </main>
  )
